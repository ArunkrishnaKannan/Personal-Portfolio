      ...
      <div className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
        ...
        <div className="flex mt-8 gap-2">
          <div className="flex items-center justify-center">
           ...
           <a href="/public/ArunKrishnaResume.pdf" target="_blank"><button  className="neon-button shadow-xl hover:shadow-green-200/50 text-white border-2 hover:bg-green-500 border-green-500 rounded-lg py-4 px-8 uppercase relative overflow-hidden">Resume</button></a>
            </div>
          </div>
        </div>
      </div>
